...
export (PackedScene) var launch_projectile = preload("res://DEV_ExampleUsages/Ex_LevelCreationTest/MegaMan_Level/EnemyObj/100WattonBomb.tscn")
export (PackedScene) var launch_smoke_effect = preload("res://DEV_ExampleUsages/Ex_LevelCreationTest/MegaMan_Level/Effects/100WattonSmokeEffect.tscn")
