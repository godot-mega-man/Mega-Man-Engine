...
var debris = preload("res://DEV_ExampleUsages/Ex_LevelCreationTest/MegaMan_Level/EnemyObj/FreezeDebris.tscn")
var ice_shard_effect = preload("res://DEV_ExampleUsages/Ex_LevelCreationTest/MegaMan_Level/Effects/IceShardEffect.tscn")
var icicle = preload("res://DEV_ExampleUsages/Ex_LevelCreationTest/MegaMan_Level/EnemyObj/Icicle.tscn")
