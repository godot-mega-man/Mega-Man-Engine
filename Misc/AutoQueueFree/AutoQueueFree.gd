...
#The main use of this is the case you want unused node
#within the scene to be removed as soon as the scene entered.
...
#
# exp var one_time_use : Allow the use of this node once.
# exp var allow_signal_connect_call : Determine whether this node
