...
onready var sfx_combat_fall : AudioStreamPlayer = $SFX/Combat/Sfx_Fall
...
onready var sfx_combat_hop : AudioStreamPlayer = $SFX/Combat/Sfx_Hop
...
onready var sfx_combat_peat : AudioStreamPlayer = $SFX/Combat/Sfx_Peat
...
onready var sfx_combat_thunder : AudioStreamPlayer = $SFX/Combat/Sfx_Thunder
...
onready var sfx_ui_select : AudioStreamPlayer = $SFX/UI/Sfx_Select
